...
function Addexpensecard() {
  return (
    <div className="flex justify-center">
      <div className="flex flex-col w-96 items-center border border-gray-400 pt-0 m-2 rounded-md shadow shadow-gray-700">
        ...
        <div className="m-4 flex flex-row justify-center">
          ...
          <div className="ml-4">
            <div className="mx-8 text-gray-300 text-xl">
              Enter a discription
            </div>
        ...
        <div className="m-2 flex justify-end w-full">
          <button className="bg-gray-200 rounded-md px-3 py-2 m-2  border-gray-500">
            Cancel
          </button>
