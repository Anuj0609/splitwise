...
export const Dashboard = () => {
  ...
  console.log(groups);
  return (
    <div className="max-w-[250px] p-2 w-full">
      <div className="flex flex-col items-start text-gray-300 text-end">
        ...
        <div className="flex flex-row items-center space-x-2 text-gray-700 w-full mt-2">
          <FiFlag />
      ...
      {/* Groups Section */}
      <div className="flex flex-row justify-between w-full text-gray-400 bg-gray-100 text-xs p-2 rounded-sm hover:bg-gray-300 mt-4">
        <div>GROUPS</div>
      ...
      <div className="mt-2">
        <div className="flex flex-row items-center text-gray-500 text-sm font-semibold hover:bg-gray-200 mb-2 px-2 w-full">
          <FiTag />
      ...
      <div className="mt-2">
        ...
        <div className="flex flex-row items-center text-gray-500 text-sm font-semibold hover:bg-gray-200 px-2 w-full">
          <AiOutlineUser />
      ...
      <div className="flex flex-col border border-gray-500 rounded-sm w-full mt-4">
